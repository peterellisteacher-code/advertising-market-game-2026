...
func _assert_hud(progress: AdMarketAgencyProgress) -> void:
	...
	assert(not hud.get_node("HudMargin/HudStack/ExpandedDetails/GoalBlock").is_visible_in_tree())
	assert(not hud.get_node("HudMargin/HudStack/ExpandedDetails/ProgressBlock").is_visible_in_tree())
	assert(not hud.get_node("HudMargin/HudStack/ExpandedDetails/TravelBlock").is_visible_in_tree())
	assert(not hud.get_node("%HudSoundToggle").is_visible_in_tree())
	assert(hud.get_node("HudMargin/HudStack/PrimaryRow/ObjectiveBlock").is_visible_in_tree())
	...
	assert(hud.get_node("HudMargin/HudStack/ExpandedDetails/GoalBlock").is_visible_in_tree())
	assert(hud.get_node("HudMargin/HudStack/ExpandedDetails/ProgressBlock").is_visible_in_tree())
	assert(hud.get_node("HudMargin/HudStack/ExpandedDetails/TravelBlock").is_visible_in_tree())
	assert(hud.get_node("%HudSoundToggle").is_visible_in_tree())
