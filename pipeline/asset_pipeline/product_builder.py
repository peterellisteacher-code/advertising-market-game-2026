...
BODY_GEOMETRIES: dict[str, BodyGeometry] = {
    ...
    "body-sports-bottle": BodyGeometry(
        ...
        artwork_path="M288 350Q500 402 712 350V750Q500 780 288 750Z",
    ...
    "body-weekender": BodyGeometry(
        ...
        artwork_path="M220 500Q500 445 780 500V650Q500 700 220 650Z",
...
COMPONENT_GEOMETRIES: dict[str, ComponentGeometry] = {
    ...
    "part-closure-tabbed": ComponentGeometry(
        ...
        "closure",
        (0.1, 0.2, 0.8, 0.6),
        '<path d="M.12 .72V.3H.4L.5 .22L.6 .3H.88V.72Z"/><path d="M.38 .5H.62" fill="none"/>',
    ),
